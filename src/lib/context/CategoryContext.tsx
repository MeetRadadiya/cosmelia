...
const INITIAL_CATEGORIES: DynamicCategory[] = [
  {
    ...
    description: "Multi-wavelength light beauty masks",
  ...
  },
  {
    ...
    description: "Facial and neck massage tools",
  ...
  },
  {
    ...
    description: "Cooling facial rollers and globes",
  ...
  },
  {
    ...
    name: "Pimple Patches",
    displayName: "Pimple & Spot Patches",
    description: "Hydrocolloid spot covers and patches",
  ...
  },
  {
    ...
    slug: "eye-patche-22",
    name: "Eye Patche",
    displayName: "Under-Eye Patches",
    description: "Hydrating under-eye hydrogel patches",
