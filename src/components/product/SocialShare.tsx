...
export const SocialShare: React.FC<SocialShareProps> = ({ title, url }) => {
  ...
  const [shareUrl, setShareUrl] = useState(url || "https://getcosmelia.com");
      ...
      <div className="flex items-center gap-2 text-[11px] font-semibold text-[#8C734B] uppercase tracking-[0.2em] mb-3">
        ...
        >
          <path
            ...
            d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 100-5.367 3 3 0 000 5.367zm0 8.005a3 3 0 100-5.367 3 3 0 000 5.367z"
          />
        </svg>
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        >
          {copied ? (
            ...
            <>
              <svg
                className="w-3.5 h-3.5 text-[#141416]"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                strokeWidth="2"
